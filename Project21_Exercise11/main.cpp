/*
*	Exercise 11
*	Using the last transformation on the container, try switching the order 
*	around by first rotationf and then translating. See wha happens and try 
*	to reason why this happens.	
*/
...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Project21_Exercise11", nullptr, nullptr);
...
A rotation transdormation is also known as a change-of-basis transformation 
...
look as if its circling around the origin of the scene.
